...
void CongTy::hien_thi_menu_dich_vu() {
	ds_dich_vu.hien_thi_menu_dich_vu(ds_khach_hang, ds_nhan_vien, ds_phuong_tien, ds_dia_danh, ds_luu_tru);
}
...
void CongTy::nhap() {
	...
	do {
		...
		case 7: {
			ds_dich_vu.them(ds_khach_hang, ds_nhan_vien, ds_phuong_tien, ds_dia_danh, ds_luu_tru);
			ds_dich_vu.hien_thi(); 
			break;
		}
		case 0:
